...
- **Install**: [Plugin installation](../../apps/plugin/README.md#installation) — build, copy `WinPodiums.Plugin.dll` to `C:\Program Files (x86)\SimHub\` (install root; only supported SimHub path), restart SimHub
