...
- **GitHub**: Change control, PRs, secrets; use the github-change-control skill when relevant. PRs must use the PR template with Traceability, Doc links, and traceability labels (see [CONTRIBUTING](CONTRIBUTING.md) and [ContextStream mapping §1.4](docs/guides/contextstream-mapping.md#14-linking-pull-requests-to-tech-plans-and-prds-graph-visible)).
