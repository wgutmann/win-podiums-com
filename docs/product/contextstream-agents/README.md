...
**ContextStream**: PRD-009/TP-009 and PRD-011/TP-011 use stable IDs and **Related** / **Implements** for knowledge graph linking. See [ContextStream mapping](../../guides/contextstream-mapping.md).
...
| [PRD-011: ContextStream Knowledge Ingest (GitHub API)](002-contextstream-knowledge-ingest.md) | Draft | 1.0 | [TP-011](../../tech-plans/contextstream-agents/002-contextstream-knowledge-ingest-implementation.md) | Automated GitHub API ingestion workflow for knowledge graph |
